# Embedded file name: c:\Jenkins\live\output\win_32_static\Release\midi-remote-scripts\APC40_MkII\APC40_MkII.py
...
class APC40_MkII_Mod(APC, OptimizedControlSurface):

    def __init__(self, *a, **k):
        super(APC40_MkII_Mod, self).__init__(*a, **k)
